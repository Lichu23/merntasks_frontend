...
const ModalFormularioTarea = () => {
    ...
    const handleSubmit = async e => {
       ...
       await submitTarea({id,nombre, descripcion, fechaEntrega , 
        prioridad, proyecto: params.id})
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h3" className="text-xl text-center leading-5 font-bold text-gray-900">
                                    ...
                                    <form 
                                        ...
                                        <input 
                                            ...
                                            transition-colors rounded mb-5 '
